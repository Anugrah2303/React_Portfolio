            ...
            <section className="pt-25 pb-6 md:px-35" ref={preView}>
                <div className="flex flex-col md:static justify-center items-center gap-5">
                    ...
                    <div className="relative rounded-xl shadow-(--shadow-sm) hover:shadow-(--shadow-md) transition-all duration-200 mx-auto  max-w-150 flex justify-center md:flex-row flex-col items-center">
                        ...
                        <div ref={previewBadge} className="md:absolute flex gap-5 -top-10 -left-30 bg-(--bg-main) shadow-(--shadow-md) pl-7 pr-3 py-2 rounded-xl">
                            <div className="flex flex-col gap-2 my-2 text-nowrap">
                                <SubHeading title="Anugrah Rakholiya" className="font-primary badgeSubHeading" />
                                <div className="badgeMiniButton">
                                    <MiniButton tech="Web Developer" />
                                </div>
                            </div>
                        </div>

                        <div className={` ${viewDetail ? "block" : "hidden"} w-full md:ml-35 px-5 md:px-0 pt-7 pb-3 md:py-2.5 md:flex flex-row justify-center md:flex-col items-center gap-3`}>
